...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FtZWVyNTkiLCJhIjoiY2tocHJtdzRvMHpuODJ2azZpM2F0dW9zOSJ9.SrNl_idaw-ijP-WyhIlPig';
  var map = new mapboxgl.Map({
    container: 'map',
    // what that means is that it will put the map on an element with the ID of 'map'.
    //style: 'mapbox://styles/mapbox/streets-v11', // this is default style
    style: 'mapbox://styles/sameer59/ckhpthbqx0e3r19npooqaamjb',
    // this is our custom style using Mapbox Studio
...
var hideAlert = function hideAlert() {
  ...
  var el = document.querySelector('.alert'); // remove the alert.
...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert(); // create markup with 'alert' class
  // and based on type (success/error), add alert--success or alert--error css class

  var markup = "<div class='alert alert--".concat(type, "'>").concat(msg, "</div>"); // show error at the start of the body element

  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // hide alert after 5 seconds

  window.setTimeout(hideAlert, 5000); // above line is same as below commented piece of code
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in sucessfully'); // navigate to home page after 1.5 seconds
...
var stripe = Stripe('pk_test_51HqsfzKaPgCpuarzT2fgnG9woReuZucrPyFfRZ2UHInklIMVyQnBlBBe5QHN2cUDdv1oSlToIblfumvNHVPGGNo700rI7cH0Da');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var savePassBtn, passwordCurrent, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              savePassBtn = document.querySelector('.btn--save-password');
              savePassBtn.textContent = 'Updating...'; // get input form data

              passwordCurrent = document.getElementById('password-current').value;
              password = document.getElementById('password').value;
              passwordConfirm = document.getElementById('password-confirm').value; // call /updateMyPassword API and await so that we can then clear input fields, etc.
            ...
            case 8:
              ...
              savePassBtn.textContent = 'Save Password'; // clear input fields
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // const { tourId } = e.target.dataset; // standard JS: data-tour-id => will be dataset.tourId

    var tourId = e.target.dataset.tourId; // standard JS: data-tour-id => will be dataset.tourId
